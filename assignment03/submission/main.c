...
int main() {
    ...
    process_array = load_file("./input.txt"); //TODO: Change this to just "input.txt" before submitting
    ...
    switch (header.algorithm) {
        ...
        case PR_NO_PREMP:
            ...
            priority(process_array, header.num_processes, outbuf, 0);
            write_file("output.txt", outbuf);
            printf("Output written to output.txt\n");
            break;
        case PR_PREMP:
            ...
            priority(process_array, header.num_processes, outbuf, 1);
            write_file("output.txt", outbuf);
            printf("Output written to output.txt\n");
            break;
        default:
